...
def Beam(fileName):
    try:
        ...
        mdb.models['Model-1'].DisplacementBC(name='BC-1', createStepName='Step-1', 
            ...
            localCsys=None)
        session.viewports['Viewport: 1'].view.setValues(nearPlane=1798.16, 
            farPlane=2533.32, width=1014.35, height=453.387, cameraPosition=(
            1471.81, 1251.45, -479.166), cameraUpVector=(-0.673042, 0.57735, 
            0.462256), cameraTarget=(-17.5891, -26.1896, 543.779))
        
        a = mdb.models['Model-1'].rootAssembly
        f1 = a.instances['Beam1-1'].faces
        faces1 = f1.findAt(((point[0], point[1], 1000.0),))
        ...
        mdb.models['Model-1'].Gravity(name='Load-1', createStepName='Step-1', 
            comp2=-10.0, distributionType=UNIFORM, field='')
        ...
        session.viewports['Viewport: 1'].odbDisplay.commonOptions.setValues(
            deformationScaling=UNIFORM, uniformScaleFactor=1e-6)
        
        session.viewports['Viewport: 1'].odbDisplay.contourOptions.setValues(maxAutoCompute=OFF, minAutoCompute=OFF)
    
        session.viewports['Viewport: 1'].odbDisplay.contourOptions.setValues(maxValue=1e9, minValue=1e7)
        ...
        results_file_path = '/bendingResults.txt'
